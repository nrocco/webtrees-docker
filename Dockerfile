...
# TODO: RUN wget "https://github.com/magicsunday/webtrees-fan-chart/releases/download/3.3.6/webtrees-fan-chart.zip" && unzip -d /var/lib/webtrees/modules_v4 webtrees-fan-chart.zip && rm -f webtrees-fan-chart.zip
